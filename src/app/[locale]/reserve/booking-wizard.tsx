...
export function BookingWizard() {
  ...
  }, [state.program, state.groupSize, state.wantsPhoto, state.liftPassPayment, content]);
  ...
  function handleSubmit() {
    ...
    startTransition(async () => {
      ...
      if (!response.success) {
        setError(content.bookingWizard.errorGeneric);
        return;
      }
  ...
  if (result) {
    return <CompletionView name={result.name} content={content} />;
  }
    ...
    <div className="mx-auto flex min-h-[100svh] max-w-2xl flex-col px-5 py-10 sm:px-6">
      ...
      <div className="mt-10 flex items-center gap-3">
        ...
        {step < totalSteps ? (
          ...
          >
            {isPending
              ? content.bookingWizard.buttons.submitting
  ...
  return (
    <div className="mx-auto flex min-h-[100svh] max-w-lg flex-col items-center justify-center px-5 py-10 text-center">
      ...
      <h1 className="mt-6 text-[26px] font-bold tracking-tight text-ink-900">
        {content.bookingWizard.completion.title}
      </h1>
      <p className="mt-3 text-[15px] leading-relaxed text-snow-700">
        {content.bookingWizard.completion.body(name)}
      </p>
      ...
      >
        ...
        {content.bookingWizard.completion.kakaoButton}
      </a>
      ...
      >
        {content.bookingWizard.completion.backHome}
      </Link>
    </div>
  );
}
