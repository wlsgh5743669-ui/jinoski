// ============================================================================
// JinoSki — 중앙 브랜드/콘텐츠 설정 파일
// 실제 운영 정보(전화, SNS, 이메일, 강사 프로필, 후기 등)는 전부 이 파일에서만
// 관리합니다. 값이 바뀌면 이 파일만 수정하면 사이트 전체에 반영됩니다.
// ============================================================================
...
export const siteConfig = {
  ...
  url: "https://jinoski.com", // 실제 도메인 연결 후 교체
...
export const heroContent = {
  ...
  description:
    "JinoSki는 비발디파크 프리미엄 스키·스노보드 레슨을 제공합니다.",
...
export const statsEyebrow = "Trusted by Hundreds of Skiers";
...
export const whyJinoSki = [
  {
    number: "01",
    title: "풍부한 현장 경험",
    description:
      "8년 이상의 강습 경험을 바탕으로 실력과 목표에 맞는 레슨을 제공합니다.",
    icon: "Award",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    title: "비발디파크 전문",
    description:
      "비발디파크 슬로프와 지형을 고려해 효율적이고 만족도 높은 레슨을 제공합니다.",
    icon: "Mountain",
  },
  {
    number: "04",
...
export const fullCarePrograms = [
  {
    ...
    duration: "약 8시간",
    rows: [
      { people: "1인", price: "550,000원" },
      { people: "2인", price: "700,000원" },
      { people: "3인", price: "900,000원" },
    ],
...
export const liftPassPricing = [
  { duration: "2시간", price: "25,000원" },
  { duration: "3시간", price: "35,000원" },
  { duration: "4시간", price: "50,000원" },
];
